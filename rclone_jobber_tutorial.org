...
The tutorial is written for Linux, and most of the contents is also useful for macOS and [[https://docs.microsoft.com/en-us/windows/wsl/about][Windows 10 wsl]].
...
Comments at the end of a rule is not supported because file names can contain a '#'.
...
After you schedule backup jobs, you will have an automated back up system that follows this workflow:
