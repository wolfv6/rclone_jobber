...
Logging options in rclone_logger.sh are headed by "#set" comments, with default values set on following line.
You can edit the variables following the "#set" comments.
...
In rclone_jobber.sh, set the new log_file value:
#+BEGIN_EXAMPLE
    #set log_file
