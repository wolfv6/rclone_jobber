...
The examples are of making backups for a home PC.
...
* Install rclone
Install the latest rclone from https://rclone.org/downloads/ or,
if your package manager has the latest version, ...
...
This tutorial use path variables $rclone_jobber and $usb e.g.:
