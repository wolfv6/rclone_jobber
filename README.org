...
rclone_jobber.sh is a Bash script to make backups.
...
- Move old files to dated directory (easy to restore deleted directory)
- Move old files to dated files (easy to brows file history, like Time Machine)
